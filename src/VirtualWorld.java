   ...
   extends PApplet
{
   ...
   private static final String BLACK_HOLE_BACKGROUND_ID = "blackHoleBackground";
   ...
   */
   public void setup()
   {
      ...
      this.view = new WorldView(VIEW_ROWS, VIEW_COLS, this, world,
         TILE_WIDTH, TILE_HEIGHT, imageStore);
      ...
      EventScheduler scheduler, ImageStore imageStore)
   {
      for (Entity entity : world.getEntities())
      {
         ...
         if (entity instanceof ActivityEntity &&
             ((ActivityEntity)entity).getActionPeriod() > 0)
            ((ActivityEntity) entity).scheduleActions(world, scheduler, imageStore);
      }
   }
   ...
   public void mousePressed()
   {
      ...
      if(!world.isOccupied(pressed))
      {
         ...
         Background newBackground = new Background(BLACK_HOLE_BACKGROUND_ID,
                 imageStore.getImageList(BLACK_HOLE_BACKGROUND_ID));

         this.world.setBackground(pressed, newBackground);

         BlackHole blackHole = BlackHole.createBlackHole(pressed, imageStore, oldBackground);

         world.addEntity(blackHole);
         blackHole.scheduleActions(world, scheduler, imageStore);
         blackHole.createGastly(world, scheduler, imageStore);
      }
   }

   private Point mouseToPoint(int x, int y)
   {
      return this.view.getViewport().viewportToWorld(x/TILE_HEIGHT, y/TILE_WIDTH);
   }
}
